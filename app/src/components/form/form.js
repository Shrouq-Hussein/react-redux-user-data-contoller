...
const UserForm = (props) => {
    ...
    const formik = useFormik(
        {
            initialValues: {
                ...( props.userid? {firstName:activeUser.firstName }:{firstName:""}),
                ...( props.userid? {lastName:activeUser.lastName }:""),
                ...( props.userid? {title:activeUser.title }:""), 
                ...( props.userid? {email:activeUser.email }:""),           
            }
            ,
            validate
            ,
